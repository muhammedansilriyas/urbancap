  ...
  return (
    <div className="min-h-screen flex bg-black">
      ...
      >
        {/* Logo */}
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-white">Urben Admin</h2>
        ...
        <div className="border-t border-gray-800 pt-4">
          <button
            ...
            className="w-full px-4 py-3 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 shadow-lg transition duration-300 transform hover:scale-105"
          >
